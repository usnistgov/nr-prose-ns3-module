          ...
          if (newRelay.l2Id != 0)
            {
              ...
              if (newRelay.l2Id == m_currentSelectedRelay.l2Id)
              ...
              else
                {
                  ...
                  AddDirectLinkConnection (m_l2Id, remoteIp, newRelay.l2Id, true, newRelay.relayCode, slInfo);
                }
            }
...
NrSlUeProse::ConfigureDataRadioBearersForU2nRelay (uint32_t peerL2Id,
                                                   ...
                                                   const struct SidelinkInfo& slInfo)
{
  NS_LOG_FUNCTION (this << peerL2Id << relayInfo.role << ipInfo.peerIpv4Addr << slInfo.m_dstL2Id << slInfo.m_srcL2Id);
