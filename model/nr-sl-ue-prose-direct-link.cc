...
NrSlUeProseDirectLink::SendDirectLinkEstablishmentAccept()
{
    ...
    uint8_t lcId =
        2; // pdlEsAc is a protected PC5 message to be sent in SL-SRB2 (TS 38.331 - Section 9.1.14)
...
NrSlUeProseDirectLink::SendDirectLinkEstablishmentReject(uint8_t cause)
{
    ...
    uint8_t lcId =
        2; // pdlEsRj is a protected PC5 message to be sent in SL-SRB2 (TS 38.331 - Section 9.1.14)
