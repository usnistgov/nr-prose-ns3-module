...
void
NrSlDiscoveryHeader::SetRelayAnnouncementParameters(uint32_t serviceCode,
...
void
NrSlDiscoveryHeader::SetRelaySoliciationParameters(uint32_t serviceCode,
...
void
NrSlDiscoveryHeader::SetRelayResponseParameters(uint32_t serviceCode,
