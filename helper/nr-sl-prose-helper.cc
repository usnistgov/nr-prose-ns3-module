										  ...
										  Ptr<NetDevice> trgtUe, Ipv4Address trgtUeIp, struct SidelinkInfo& trgtSlInfo)
{
  ...
  //Initiating UE
  Simulator::Schedule (time, &NrSlUeProse::AddDirectLinkConnection, initUeProse, initUeL2Id, initUeIp, trgtUeL2Id, true, 0, initSlInfo);

  //Target UE
  Simulator::Schedule (time, &NrSlUeProse::AddDirectLinkConnection, trgtUeProse, trgtUeL2Id, trgtUeIp, initUeL2Id, false, 0, trgtSlInfo);
